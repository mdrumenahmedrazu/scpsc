...
<body>
	...
	<center><img src="http://www.sylhetcpsc.edu.bd/images/site/123.png" style="height: 50px; padding-top:10px;" alt=""></center><br><br>
	<a href="../index.php" class="btn btn-primary"><i class="fa fa-arrow-circle-left"></i> Back</a>
	<button class="btn btn-primary" type="button" data-toggle="modal" data-target="#myModal">
  <i class="fa fa-plus"></i> Admit New Student
  </button>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
		...
		<center><img src="http://www.sylhetcpsc.edu.bd/images/site/123.png" width="80px" height="80px" alt=""></center>
        <h4 class="modal-title text-center">Admission Form</h4>
      </div>
